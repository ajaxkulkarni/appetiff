...
public class TiffinDBTest {
	...
	public void testGenerateOrders() {
		com.rns.tiffeat.web.bo.domain.Vendor vendor = new com.rns.tiffeat.web.bo.domain.Vendor();
		vendor.setId(9);
		vendorBo.generateCurrentOrder(vendor);
	}*/
	
	@Test
	public void testDelieverTiffins() {
		com.rns.tiffeat.web.bo.domain.Vendor vendor = new com.rns.tiffeat.web.bo.domain.Vendor();
		vendor.setId(9);
		List<CustomerOrder> orders = vendorBo.getAllOrders(vendor);
	...
	public void testSendMail() {
		...
		try {
			...
			message.setRecipients(Message.RecipientType.TO,
				InternetAddress.parse("rajeshmangale0802@gmail.com"));
			message.setSubject("Thank you for ordering tiffin...");
			message.setText("Thank you for ordering tiffin from us!");
