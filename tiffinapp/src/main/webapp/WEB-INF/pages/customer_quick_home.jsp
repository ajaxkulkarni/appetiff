...
<body >
	...
	<%-- <fmt:parseDate pattern="yyyy-MM-dd" var="nowDate">${nowDateString}</fmt:parseDate> --%>
						...
						<c:choose>
							<c:when test="${quickOrderDate ne nowDateString}">
								<h3 class="menu_list_title">You have ordered ${quickOrder.meal.title}
									for tomorrow's(${quickOrderDate}) ${quickOrder.mealType}. You can check the menu some hours before it.</h3>
							</c:when>
                			...
                			<c:when test="${quickOrder.content == null }">
								<h3 class="menu_list_title">${quickOrder.meal.title} menu
									for ${quickOrder.mealType} is not currently available.</h3>
							</c:when>
							<c:otherwise>
								<div class="col-md-6">
									<h3 class="menu_list_title">Today's
											${quickOrder.mealType} menu of Tiffin
											${quickOrder.meal.title} is:</h3>
