...
<body>
    ...
    <div class="container-fluid tiffin_banner">
        ...
        <div class="container banner_sub_div">
            ...
            <div class="row">
            	<form action="getNearbyVendors" method="post">
                <div class="col-md-4">
    ...
    <div class="container menu_cards_div">
    <c:if test="${fn:length(vendors) gt 0}">
    <h4 class="menu_card_heading">Tiffins in ${pinCode}</h4>
    	<div class="row">
        	...
        	<a href="getVendorMeals.htm?vendorEmail=${vendor.email}">
            	<div class="col-md-4">
                	<div class="menu_card">
                    	...
                    	<input id="input-2a" value="1" class="rating" min="0" max="5" step="0.5" data-size="sm" data-symbol="&#xf005;" data-glyphicon="false" data-rating-class="rating-fa">
                	</div>
            	</div>
         	</a>
         </c:forEach>
