...
<body>
    ...
    <%-- <%} else { %>
    <script src="<c:url value = "../../resources/assets/js/star-rating.js"/>" type="text/javascript"></script>
    <script src="<c:url value="../../resources/assets/js/wow.min.js"/>"></script>     
    <script src="<c:url value="../../resources/assets/js/custom.js"/>"></script>   
    <script src="<c:url value="../../resources/assets/js/jquery.drawer.min.js"/>"></script>
    <%} %> --%>
    <script>
